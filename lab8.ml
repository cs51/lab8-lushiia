...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    ...
    match evt with
      | [] -> []
    | hd::tl -> if (hd.id = i) then helper tl else hd :: helper tl
    in evt := helper !evt
...
let y = WEvent.add_listener newswire buzzFake;;
(* .. *)
...
WEvent.remove_listener newswire y;;
...
let z = WEvent.add_listener newswire receive_report;;
